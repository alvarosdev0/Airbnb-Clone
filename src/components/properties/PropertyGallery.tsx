        ...
        {images.length > 1 && (
          <>
            <button
              type="button"
              onClick={goPrevious}
              className="absolute left-3 top-1/2 -translate-y-1/2 rounded-full bg-bg/80 p-2 shadow-md backdrop-blur-sm transition-colors hover:bg-bg"
            ...
            <button
              type="button"
              onClick={goNext}
              className="absolute right-3 top-1/2 -translate-y-1/2 rounded-full bg-bg/80 p-2 shadow-md backdrop-blur-sm transition-colors hover:bg-bg"
            ...
            {/* Image counter */}
            <div className="absolute bottom-3 left-1/2 -translate-x-1/2 rounded-full bg-secondary/70 px-3 py-1 text-xs text-bg">
