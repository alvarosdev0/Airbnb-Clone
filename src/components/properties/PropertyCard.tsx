...
/**
 * Server Component: Travelio-style property card.
 * Shows thumbnail, name, OSM stars, category, type, top amenities,
 * and city/country. Links to the property detail page.
 */
        ...
        <div className="flex items-start justify-between gap-2 min-w-0">
          ...
          {property.stars != null && property.stars > 0 && (
            <div className="flex shrink-0 items-center gap-0.5 text-sm">
              ...
              <span className="font-medium text-text-primary">{property.stars}</span>
            </div>
          )}
        </div>
